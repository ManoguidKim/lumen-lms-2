...
<body class="bg-gray-50">
     <!-- Hero Section -->
     <section class="min-h-screen relative overflow-hidden flex items-center" style="background: linear-gradient(135deg, #3b82f6, #6366f1, #8b5cf6);">

          <!-- Grid Background -->
          <div class="absolute inset-0">
               <svg class="w-full h-full" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
                    <defs>
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full relative z-10 fade-in">
               <div class="text-white max-w-4xl">
                    ...
                    <div class="flex flex-wrap gap-4">
                         <a href="#features" class="bg-yellow-400 text-gray-900 px-8 py-3 rounded-full font-semibold hover:bg-yellow-300 transition-colors shadow-lg">
                              About
                         </a>
                         <a href="{{ route('login') }}" class="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-blue-700 transition-colors">
                              Get Started
                         </a>
                    </div>
     ...
     <section id="features" class="py-20 bg-white">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               <div class="text-center">
                    <h2 class="text-4xl font-bold text-gray-900 mb-4">Why Choose Lumen Generation?</h2>
                    <p class="text-xl text-gray-600">Building the future of Filipino excellence, one skill at a time.</p>
               </div>
          </div>
     </section>
</body>
