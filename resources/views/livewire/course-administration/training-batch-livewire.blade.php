            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50">
                        ...
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Batch Code</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Course Name</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Course Code</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Start Date</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">End Date</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Max Participants</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider"># of Participants</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition">
                        ...
                        <td class="px-5 py-3.5 text-gray-600">
                            {{ $trainingBatch->max_participants }}
                        </td>
                        <td class="px-5 py-3.5 text-gray-600">
                    ...
                    <tr>
                        <td colspan="10" class="px-5 py-4 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-400">No training batches found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
