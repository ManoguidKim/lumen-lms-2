<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <div>
            <h1 class="text-xl font-semibold text-gray-800">Learner Training Applications</h1>
            <p class="text-sm text-gray-400 mt-0.5">Manage and monitor all training applications of learner</p>
        </div>
            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50">
                        ...
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Application Number</th>
                        ...
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Reviewed By</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Reviewed At</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Reviewed Remarks</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition">
                        ...
                        <td class="px-5 py-3.5 text-gray-600">
                            {{ $application->course_name }} - {{ $application->course_code }}
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="10" class="px-5 py-4 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-400">No training applications found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
