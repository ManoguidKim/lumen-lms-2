<x-layouts.auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            @csrf
            <!-- Name -->
            <flux:input name="name" :label="__('First Name')" type="text" required autofocus autocomplete="name"
                :placeholder="__('First name')" />
            <flux:input name="last_name" :label="__('Last Name')" type="text" required autofocus autocomplete="name"
