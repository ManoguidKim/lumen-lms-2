<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <div>
            <h1 class="text-xl font-semibold text-gray-800">Center Trainers</h1>
            <p class="text-sm text-gray-400 mt-0.5">Manage and monitor all center trainers</p>
        </div>
            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50">
                        ...
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Code</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Center Name</th>
                        <th class="px-5 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Trainer Name</th>
                        <th class="px-5 py-3"></th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($trainerCenters as $trainer)
                    ...
                    <tr>
                        <td colspan="5" class="px-5 py-4 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-400">No trainer centers found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <!-- Pagination -->
    @if ($trainerCenters->hasPages())
    <div class="mt-4">
        {{ $trainerCenters->links() }}
    </div>
    @endif
</div>